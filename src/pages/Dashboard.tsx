...
export const Dashboard = () => {
    ...
    const fetchData = async () => {
        try {
            ...
            const leaderboardResponse = await axios.get(`${API_BASE_URL}/leaderboard/student`);
                ...
                <div className="max-w-6xl mx-auto">
                    ...
                    <div className="flex items-center gap-4">
                        <p className="text-dark-100">
                            Current Points: <span className="font-semibold">{tasks.reduce((sum, task) => sum + task.points, 0)}</span>
                        </p>
                    </div>
                </div>
            </header>
